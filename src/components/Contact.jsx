      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          ...
          <motion.a
            ...
            className="glass p-8 rounded-[32px] flex flex-col items-center gap-4 hover:border-blue-500/50 transition-all group"
          >
            <div className="w-12 h-12 rounded-2xl bg-blue-600/10 flex items-center justify-center border border-blue-500/20 group-hover:bg-blue-600 transition-colors">
